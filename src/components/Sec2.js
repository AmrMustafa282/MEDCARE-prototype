...
const Sec2 = () => {
  return (
    <div className='relative  pt-20 pb-36 bg-[#FFFFFF]'>
      ...
      <div className='z-0 hidden lg:block absolute top-48 left-20 animate-[bouncec_3s_ease_infinite]'> <img src={require('../Assets/anmi8.png')} alt="" /></div>
      <div className='z-0 hidden lg:block absolute top-72 right-32 animate-[spin_25s_ease_infinite]'> <img src={require('../Assets/anmi8.png')} alt="" /></div>
      <div className='z-0 hidden lg:block absolute bottom-32 left-56 animate-[swipe_3s_ease-in-out_infinite]'> <img src={require('../Assets/anmi9.png')} alt="" /></div>
      <div className='z-0 hidden lg:block absolute bottom-8 right-12 animate-[swipe_4s_ease-in-out_infinite]'> <img src={require('../Assets/anmi11.png')} alt="" /></div>
      <div className='z-0 hidden lg:block absolute bottom-0 left-[65%] animate-[bouncec_4s_ease-in-out_infinite]'> <img src={require('../Assets/anmi10.png')} alt="" /></div>
